...
LuvLetterFeatureWindowConfig NativeConfigurationSanitizer::DefaultFeatureWindow() noexcept
{
...
LuvLetterFeatureWindowConfig NativeConfigurationSanitizer::SanitizeFeatureWindow(
	const LuvLetterFeatureWindowConfig& config) noexcept
{
	auto sanitized = DefaultFeatureWindow();
